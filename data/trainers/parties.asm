...
FalknerGroup:
	...
	db  53, DODRIO,   FOCUS_BAND,   ENDURE, REVERSAL, DRILL_PECK, TRI_ATTACK
	db  54, MURKROW,  NO_ITEM,      WINDSTORM, FAINT_ATTACK, HAZE, ICY_WIND
	db  55, PIDGEOT,  NO_ITEM,      WINDSTORM, EXTREMESPEED, DOUBLE_TEAM, STEEL_WING
	db -1 ; end
...
WhitneyGroup:
	...
	db 21, MILTANK,    MIRACLEBERRY,  ROLLOUT, ATTRACT, STOMP, RECOVER
	db -1 ; end
	...
	db 55, MILTANK,    PINK_BOW,   IRON_TAIL, ATTRACT, BODY_SLAM, RECOVER
	db -1 ; end
...
ChuckGroup:
	...
	db 30, HITMONTOP, NO_ITEM,      TRIPLE_KICK, LOW_KICK, DIG, PURSUIT
	...
	db 31, POLIWRATH, BLACKBELT_I,  HYPNOSIS, LOCK_ON, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK (2): If you battle Chuck second
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 35, HITMONTOP, NO_ITEM,      TRIPLE_KICK, LOW_KICK, DIG, PURSUIT
	...
	db 36, POLIWRATH, BLACKBELT_I,  HYPNOSIS, LOCK_ON, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK (3): If you battle Chuck third
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 37, HITMONTOP,  NO_ITEM,       TRIPLE_KICK, LOW_KICK, DIG, PURSUIT
	...
	db 38, POLIWRATH,  BLACKBELT_I,   ICE_PUNCH, LOCK_ON, SURF, DYNAMICPUNCH
	db -1 ; end
...
Rival1Group:
	...
	db 39, HOUNDOOM,   FLAMETHROWER, IRON_TAIL, BITE, HOWL
	...
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE 
	db 39, VICTREEBEL,  SLUDGE, RAZOR_LEAF, SLEEP_POWDER, GROWTH
	db 38, HOUNDOOM,    FLAMETHROWER, IRON_TAIL, BITE, HOWL
	db 39, GOLBAT,      TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK 
    ...
    db 46, HOUNDOOM,     NO_ITEM,        FLAMETHROWER, IRON_TAIL, CRUNCH, HOWL
...
KarenGroup:
	...
	db 53, MURKROW,     SHARP_BEAK,     WINDSTORM, FAINT_ATTACK, STEEL_WING, HAZE
...
; KAREN (2) Rematch
	db "KAREN@", TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		...
		db 68, MURKROW
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db SHARP_BEAK
			db WINDSTORM, PURSUIT, SWAGGER, PSYCH_UP
		db 67, MISDREAVUS
			dw $FE01, $FE01, $FE01, $FE01, $FE01 ; hp, atk, def, spd, spc
			db SPELL_TAG
...
ChampionGroup:
	...
	db 55, ZAPDOS,      MAGNET,         WINDSTORM, SKY_ATTACK, THUNDERBOLT, THUNDER_WAVE
...
CooltrainerMGroup:
	...
	db 47, PIDGEOT,   EXTREMESPEED, WING_ATTACK, WINDSTORM, STEEL_WING
...
CooltrainerFGroup:
	...
	db 45, JUMPLUFF,   GIGA_DRAIN, WINDSTORM, SLEEP_POWDER, SYNTHESIS
	db -1 ; end
	...
	db 45, MILTANK,    ROLLOUT, ATTRACT, STOMP, RECOVER
	...
	db 50, MILTANK,    ROLLOUT, ATTRACT, STOMP, RECOVER
	...
	db 55, MILTANK,    ROLLOUT, ATTRACT, STOMP, RECOVER
...
SuperNerdGroup:
	...
	db 64, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 64, VICTREEBEL,  SCOPE_LENS,      SLUDGE_BOMB, RAZOR_LEAF, SLEEP_POWDER,  GROWTH
	db 64, HOUNDOOM,    CHARCOAL,        FIRE_BLAST, IRON_TAIL, CRUNCH, HOWL
	...
	db 68, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, FLY
	db 68, VICTREEBEL,  SCOPE_LENS,      SLUDGE_BOMB, RAZOR_LEAF, SLEEP_POWDER, GROWTH
	db 68, HOUNDOOM,    CHARCOAL,        FIRE_BLAST, IRON_TAIL, CRUNCH, HOWL
...
BurglarGroup:
	...
	db 35, ARCANINE,   ROAR, EMBER, HOWL, TAKE_DOWN
...
BlackbeltGroup:
	...
	db 24, HITMONLEE,     LOW_KICK, JUMP_KICK, MEDITATE, STRENGTH
...
ExecutiveMGroup:	
	...
	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 36, MUK,        MINIMIZE, SLUDGE_BOMB, ICE_PUNCH, ACID_ARMOR
	db 37, NIDOQUEEN,  BODY_SLAM, SLUDGE_BOMB, HOWL, THUNDERPUNCH
	db 36, WEEZING,    FLAMETHROWER, SLUDGE_BOMB, SELFDESTRUCT, HAZE
...
PicnickerGroup:
	...
	db 53, NIDOQUEEN,  EARTHQUAKE, HOWL, SLUDGE_BOMB, BODY_SLAM
	db -1 ; end
	...
	db 52, JUMPLUFF,   SUNNY_DAY, WINDSTORM, LEECH_SEED, GIGA_DRAIN
