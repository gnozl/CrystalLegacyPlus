...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move SCRATCH,      EFFECT_NORMAL_HIT,         35, NORMAL,       PHYSICAL, 100, 35,   0
	move VICEGRIP,     EFFECT_NORMAL_HIT,         55, NORMAL,       PHYSICAL, 100, 30,   0
	move GUILLOTINE,   EFFECT_OHKO,                0, NORMAL,       PHYSICAL,  30,  5,   0
	move RAZOR_WIND,   EFFECT_NORMAL_HIT,         55, FLYING,       SPECIAL,   95, 30,   0
	...
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,       PHYSICAL,  80, 20,   0
	...
	move JUMP_KICK,    EFFECT_JUMP_KICK,          80, FIGHTING,     PHYSICAL,  95, 25,   0
	move HOWL,         EFFECT_ATTACK_DOWN_2,       0, DARK,         STATUS,   100, 15,   0
	...
	move WINDSTORM,    EFFECT_NORMAL_HIT,         90, FLYING,       SPECIAL,  100, 15,   0
	...
	move TAKE_DOWN,    EFFECT_RECOIL_HIT,         95, NORMAL,       PHYSICAL,  95, 20,   0
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          19, BUG,          SPECIAL,  100, 20,   0
	...
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,       STATUS,    70, 20,   0
	...
	move ROCK_THROW,   EFFECT_NORMAL_HIT,         50, ROCK,         PHYSICAL,  95, 25,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, NORMAL,       SPECIAL,   90, 15,   0
	...
	move WATERFALL,    EFFECT_FLINCH_HIT,         70, WATER,        PHYSICAL, 100, 15,  30
	...
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          22, STEEL,        SPECIAL,  100, 15,   0
	...
	move POISON_GAS,   EFFECT_POISON,              0, POISON,       STATUS,    70, 40,   0
	move BARRAGE,      EFFECT_MULTI_HIT,          20, NORMAL,       SPECIAL,  100, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          40, BUG,          SPECIAL,  100, 25,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, NORMAL,       STATUS,    75, 10,   0
	move SKY_ATTACK,   EFFECT_NORMAL_HIT,        120, FLYING,       PHYSICAL,  85, 10,   0
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,       STATUS,   100, 10,   0
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     20, WATER,        SPECIAL,  100, 30,  10
	move DIZZY_PUNCH,  EFFECT_CONFUSE_HIT,        70, NORMAL,       PHYSICAL, 100, 15,  20
	...
	move CRABHAMMER,   EFFECT_NORMAL_HIT,        110, WATER,        PHYSICAL, 100, 15,   0
	...
	move BONEMERANG,   EFFECT_DOUBLE_HIT,         50, GROUND,       SPECIAL,   90, 20,   0
	move REST,         EFFECT_HEAL,                0, PSYCHIC_TYPE, STATUS,   100,  5,   0
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         80, ROCK,         PHYSICAL,  90, 15,  30
	...
	move TRIPLE_KICK,  EFFECT_TRIPLE_KICK,        20, FIGHTING,     PHYSICAL, 100, 15,   0
	move THIEF,        EFFECT_THIEF,              60, DARK,         PHYSICAL, 100, 15, 100
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        65, FIRE,         SPECIAL,  100, 25,  10
	...
	move MACH_PUNCH,   EFFECT_PRIORITY_HIT,       50, FIGHTING,     PHYSICAL, 100, 30,   0
	...
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,       PHYSICAL, 100, 15, 100
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,        SPECIAL,  100, 15,  50
	...
	move ICY_WIND,     EFFECT_SPEED_DOWN_HIT,     65, ICE,          SPECIAL,  100, 20, 100
	move DETECT,       EFFECT_PROTECT,             0, FIGHTING,     STATUS,   100,  5,   0
	move BONE_RUSH,    EFFECT_MULTI_HIT,          25, GROUND,       PHYSICAL, 100, 20,   0
	...
	move RETURN,       EFFECT_RETURN,              1, NORMAL,       STATUS,   100, 20,   0
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,       STATUS,    90, 15,   0
	move FRUSTRATION,  EFFECT_FRUSTRATION,         1, NORMAL,       STATUS,   100, 20,   0
	...
	move MAGNITUDE,    EFFECT_MAGNITUDE,           1, GROUND,       SPECIAL,  100, 30,   0
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      70, STEEL,        PHYSICAL, 100, 25,  10
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,        1, NORMAL,       STATUS,   100, 15,   0
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   60, FIGHTING,     PHYSICAL, 100, 15,  20
